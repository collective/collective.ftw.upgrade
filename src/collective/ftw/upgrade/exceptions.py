class CyclicDependencies(Exception):
    ...
    def __init__(self, dependencies, cyclic_dependencies=()):
        super().__init__("Cyclic dependencies detected.")
...
class UpgradeNotFound(Exception):
    ...
    def __init__(self, api_id):
        self.api_id = api_id
        super().__init__(f'The upgrade "{api_id}" could not be found.')
...
class NoAssociatedProfileError(ValueError):
    ...
    def __init__(self):
        super().__init__(self, NoAssociatedProfileError.__doc__.strip())
